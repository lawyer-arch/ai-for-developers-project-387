    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label htmlFor="slotInterval" className="block text-sm font-medium text-gray-700">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="minimumBookingNotice" className="block text-sm font-medium text-gray-700">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="beforeEventBuffer" className="block text-sm font-medium text-gray-700">
          ...
          <div>
            <label htmlFor="afterEventBuffer" className="block text-sm font-medium text-gray-700">
