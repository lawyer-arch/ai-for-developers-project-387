...
- Name: booking.spec.ts >> Booking page >> shows 'Event Not Found' for invalid slug
- Location: tests/e2e/booking.spec.ts:205:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/demo/nonexistent
Call log:
  - navigating to "http://localhost:3000/demo/nonexistent", waiting until "load"
