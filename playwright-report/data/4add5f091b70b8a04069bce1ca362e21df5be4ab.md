...
- Name: booking.spec.ts >> Create Event Type >> create event type and redirect to homepage
- Location: tests/e2e/booking.spec.ts:245:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/event-types/new
Call log:
  - navigating to "http://localhost:3000/event-types/new", waiting until "load"
